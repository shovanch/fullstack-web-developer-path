...
- Try to use Github Student Pack if possible and Github pages for static sites. They are really helpful especially for student developers
- Try to have a look at React frameworks like Gatsby(Static Site Generator) and NextJs(Server side rendered)
